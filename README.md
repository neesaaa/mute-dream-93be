...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-dream-93be)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mute-dream-93be
```

A live public deployment of this template is available at [https://mute-dream-93be.templates.workers.dev](https://mute-dream-93be.templates.workers.dev)
